      ...
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-12 lg:mb-16">
          ...
          <p className="body-1 max-w-3xl mx-auto mb-2 text-n-2 lg:mb-4">
            O homem que olha para fora, sonha... o que olha para dentro, desperta!
          </p>
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <Notification
                    ...
                    imgUrl={soraiaQuemSomos}
                    title="Soraia Pereira"
                    text="SoraialexaPereira"
                  />
                </ScrollParallax>
              </div>
            </div>
